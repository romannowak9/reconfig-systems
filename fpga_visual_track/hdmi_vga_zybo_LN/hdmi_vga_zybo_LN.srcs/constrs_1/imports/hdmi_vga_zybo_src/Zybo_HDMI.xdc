...
#create_clock -add -name hdmi_in_clk_p -period 13.00 -waveform {0 6.5} [get_ports hdmi_in_clk_p]
#create_clock -period 7.00 -name hdmi_in_clk_p -waveform {0.000 3.5} [get_ports hdmi_in_clk_p] # HIGH FREQ ?
