...
#
# Generated by export_simulation on Thu May 16 17:38:43 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './delayLineBRAM.sh' script.

./delayLineBRAM.sh -reset_run
...
./delayLineBRAM.sh -noclean_files

For more information on the script, please type './delayLineBRAM.sh -help'.
