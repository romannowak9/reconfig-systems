...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L xlconstant_v1_1_7 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot hdmi_vga xil_defaultlib.hdmi_vga xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  hdmi_vga -key {Behavioral:sim_1:Functional:hdmi_vga} -tclbatch cmd.tcl -protoinst "protoinst_files/hdmi_vga.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb hdmi_vga.wdb xsim.dir)
