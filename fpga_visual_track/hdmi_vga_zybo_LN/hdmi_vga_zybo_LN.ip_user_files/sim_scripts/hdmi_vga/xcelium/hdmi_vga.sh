...
# Design libraries
design_libs=(simprims_ver xpm xil_defaultlib xlconstant_v1_1_7)
...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.hdmi_vga \
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../hdmi_vga_zybo_LN.gen/sources_1/bd/hdmi_vga/ipshared/7698" \
       +incdir+"../../../../hdmi_vga_zybo_LN.gen/sources_1/bd/hdmi_vga/ip/hdmi_vga_dvi2rgb_0_0/src/ila_pixclk/hdl/verilog" \
       +incdir+"../../../../hdmi_vga_zybo_LN.gen/sources_1/bd/hdmi_vga/ip/hdmi_vga_dvi2rgb_0_0/src/ila_refclk/hdl/verilog" \
       +incdir+"../../../../hdmi_vga_zybo_LN.gen/sources_1/bd/hdmi_vga/ipshared/7698" \
       -input simulate.do
}
