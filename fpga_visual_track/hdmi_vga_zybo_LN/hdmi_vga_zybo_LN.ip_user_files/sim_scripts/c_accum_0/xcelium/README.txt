...
#
# Generated by export_simulation on Wed May 22 18:09:36 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './c_accum_0.sh' script.

./c_accum_0.sh -reset_run
...
./c_accum_0.sh -noclean_files

For more information on the script, please type './c_accum_0.sh -help'.
