...
HD_PWD='D:/programowanie/verilog/lab8_median/hdmi_vga_zybo_LN/hdmi_vga_zybo_LN.runs/delayLineBRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log delayLineBRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source delayLineBRAM.tcl
