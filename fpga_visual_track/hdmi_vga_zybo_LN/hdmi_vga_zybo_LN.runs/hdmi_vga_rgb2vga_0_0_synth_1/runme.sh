...
HD_PWD='D:/programowanie/verilog/lab5_tor_wizyjny/hdmi_vga_zybo_LN/hdmi_vga_zybo_LN.runs/hdmi_vga_rgb2vga_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_vga_rgb2vga_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_vga_rgb2vga_0_0.tcl
