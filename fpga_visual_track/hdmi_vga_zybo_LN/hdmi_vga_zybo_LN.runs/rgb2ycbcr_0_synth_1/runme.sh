...
HD_PWD='D:/programowanie/verilog/lab6_kolor/hdmi_vga_zybo_LN/hdmi_vga_zybo_LN.runs/rgb2ycbcr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2ycbcr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb2ycbcr_0.tcl
